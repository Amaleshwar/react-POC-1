...
export default class  Imageslide  extends Component {
    ...
    render() { 
        return ( 
            ...
            <Carousel.Item>
                <img height="242" width="100%"  className=" " src={image1} alt="First slide" />
            </Carousel.Item>
            <Carousel.Item>
                <img  height="242" width="100%" className="" src={image2} alt="Second slide" />
            </Carousel.Item>
            <Carousel.Item>
                <img  height="242" width="100%" className=" " src={image3} alt="Third slide" />
            </Carousel.Item>
            </Carousel>
<h2> Carousel without Library </h2>
            <div className ="imgslide-app">
                <div className ="imgslide-wrapper">
                    ...
                    <img src={this.state.images[this.state.counter]} alt="Smiley face" height="242" width="100%" />
